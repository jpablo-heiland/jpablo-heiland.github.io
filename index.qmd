...
<div class="projects-grid">
  ...
  <div class="project-card">
    <a class="card-img-link" href="proyectos/ndvi-tres-dim/ndvi-tres-dim.html">
      <img src="img/thumb-ndvi-tres-dim.png" alt="NDVI en 3 Dimensiones" loading="lazy">
    </a>
    <div class="card-body">
      <span class="card-category cat-gee">Python · NDVI · 3D</span>
      <a class="card-title" href="proyectos/ndvi-tres-dim/ndvi-tres-dim.html">
        NDVI en 3D
      </a>
      <p class="card-desc">
        Visualización del NDVI en tres dimensiones. 
        Extracción de imagen satelital, cálculo NDVI,
        visualización con PyDeck y QGIS.
      </p>
      <div class="card-tags">
        <span class="tag tag-py">Python</span>
        <span class="tag tag-gee">GEE</span>
        <span class="tag tag-gee">NDVI</span>
        <span class="tag tag-agro">3D</span>
      </div>
    </div>
  </div>
